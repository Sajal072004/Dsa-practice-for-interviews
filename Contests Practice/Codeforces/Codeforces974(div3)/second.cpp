...
{
  return powerMod(a, mod - 2, mod); // Fermat's Little Theorem for mod inverse
}
...
int main()
{
  ...
  while (t--)
  {
    ...
    if(sumIsEvenOrOdd(n) == "Odd" && sumIsEvenOrOdd(n-k) == "Odd") cout << "YES" << endl;
    else if( sumIsEvenOrOdd(n) == "Odd") cout << "NO" << endl;
    else if(sumIsEvenOrOdd(n-k) == "Odd") cout << "NO" << endl;
    else cout <<"YES" << endl;
